        ...
        DATA.dataset.forEach(row => {
            ...
            TABLE_BODY.innerHTML += `
                <tr>
                    ...
                    <td>
                        <button id="btn_editar" title="Editar producto" type="button" class="btn" onclick="openUpdate(${row.id_producto})">
                            <i class="bi bi-pencil-fill"></i>
                        </button>
                        <button id="btn_delete" title="Eliminar producto" type="button" class="btn" onclick="openDelete(${row.id_producto})">
